...
C {ppolyf_u_lvs.sym} 220 -100 0 0 {name=R1
W=0.8e-6
L=22e-6
model=ppolyf_u
m=1}
C {ppolyf_u_lvs.sym} 220 -10 0 0 {name=R2
W=0.8e-6
L=22e-6
model=ppolyf_u
m=1}
C {ppolyf_u_lvs.sym} 220 80 0 0 {name=R3
W=0.8e-6
L=22e-6
model=ppolyf_u
m=1}
C {ppolyf_u_lvs.sym} 220 190 0 0 {name=R4
W=0.8e-6
L=22e-6
model=ppolyf_u
m=1}
