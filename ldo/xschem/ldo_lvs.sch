...
C {opamp_lvs.sym} -960 -420 0 0 {name=x1}
C {cs_vthref_lvs.sym} -1250 -320 0 0 {name=x2}
C {bgr_diode_lvs.sym} -1400 -320 0 0 {name=x3}
...
C {ppolyf_u_lvs.sym} -700 -290 0 0 {name=R1
W=0.8e-6
L=2e-2
model=ppolyf_u
m=1}
C {ppolyf_u_lvs.sym} -490 -290 0 0 {name=R2
W=0.8e-6
L=2e-2
model=ppolyf_u
m=1}
